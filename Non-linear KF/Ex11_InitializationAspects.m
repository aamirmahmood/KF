...
x_estimate_init = [100 0 0 -100 0 0]'; %x^hat(0,0)
...
legend('True vehilce position', 'Estimated vehicle position')
...
x_estimate_init = [100 0 0 0 0 0]'; %x^hat(0,0)
uncertainty_estimate_init = [500 0   0   0    0   0;...
                             0   500 0   0    0   0;...
                             0   0   500 0    0   0;...
                             0   0   0   500  0   0;...
