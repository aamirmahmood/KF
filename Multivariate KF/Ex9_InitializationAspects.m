...
legend('True vehicle position', 'Estimated vehicle position')
...
ylabel('Variance (m^2)', 'FontSize', 16, 'FontWeight', 'bold', 'Color', [0.5, 0, 0]);
...
x_estimate_init = [303 0 0 -428 0 0]'; %x^hat(0,0)
uncertainty_estimate_init = [50 0   0   0    0   0;... % Uncertainty has to be reduced to see the effect
                             0   50 0   0    0   0;...
                             0   0   50 0    0   0;...
                             0   0   0   50  0   0;...
                             0   0   0   0    50 0;...
                             0   0   0   0    0   50]; % uncertainty estimate P(0,0)
% 2. Predication
x_estimate_pred           = F*x_estimate_init;
uncertainty_estimate_pred = F*uncertainty_estimate_init*F' + Q; 
...
xlabel('Time (s)', 'FontSize', 16, 'FontWeight', 'bold', 'Color', [0.5, 0, 0]);
ylabel('Variance (m^2)', 'FontSize', 16, 'FontWeight', 'bold', 'Color', [0.5, 0, 0]);
legend('Case 1: Random Initilization', 'Case 2: Fine Initilization')
% Customizing the font size for axes
set(gca, 'FontSize', 14);